...
| 題號 | 重點單元 | 涵蓋 KP 範圍 |
|---|---|---|
| Q1-Q10 | 空間幾何與偏導 | KP1.1-2.5, KP5.1-6.5 |
| Q11-Q20 | 梯度與向量定理核心 | KP5.4, KP13.1-17.5 |
| Q21-Q35 | 跨單元綜合判定 | 全學期 KPs |
| Q36-Q50 | 公式填空與關鍵常數 | 全學期重要定義 |

*註：本考試旨在評估學生對多變數微積分與向量微積分大定理的綜合應用能力。*
